...
function ec_admin_meta_pessoa_nome( $post ) {
  $nome = get_post_meta($post->ID, '_nome', true);
  echo '<table class="form-table">';
  echo '<input type="text" name="_nome" placeholder="Seu nome" value="', $nome ? $nome : '','" size="30" style="width:75%; margin-right: 20px; float:left;" />';
  echo '</table>';
}
